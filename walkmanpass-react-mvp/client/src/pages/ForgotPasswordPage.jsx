      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 mb-3">
            ...
            <span className="text-2xl font-semibold text-gray-900">SecurePass</span>
          </div>
        ...
        <div className="glass rounded-2xl p-6 border border-gray-200/50">
          ...
          <p className="text-sm text-gray-600 mb-6">
            Utilisez votre recovery key pour réinitialiser votre master password.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1.5">Recovery Key</label>
              <input
                type="text"
                value={recoveryKey}
              ...
              />
              <p className="text-xs text-gray-500 mt-1">La clé que vous avez reçue lors de l'inscription</p>
            </div>
          ...
          <div className="mt-5 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-blue-800">
              <strong>ℹ️ Note :</strong> Tous vos mots de passe stockés seront automatiquement re-chiffrés avec votre nouveau master password.
            </p>
          </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl">
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Nouvelle Recovery Key</h2>
            <p className="text-sm text-gray-600 mb-4">Votre recovery key a été régénérée. Sauvegardez-la précieusement !</p>

            <div className="bg-gray-50 p-4 rounded-lg border-2 border-gray-200 mb-4">
              <p className="text-xs font-medium text-gray-600 mb-2">Votre nouvelle recovery key :</p>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4">
              <p className="text-xs text-red-800 font-medium">
                Notez cette clé maintenant ! Vous ne pourrez plus la voir après avoir fermé cette fenêtre.
              </p>
            </div>
